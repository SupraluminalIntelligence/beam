/** Model lists and requirements per harness, shared by the web and phone apps. Codex models come from the machine's probe when available. */
export const HARNESS_INFO: Record<string, { vendor: string; models: string[]; min: string; files: string }> = {
  claude: { vendor: "Anthropic", models: ["Fable 5.1", "Fable 5.0", "Opus 5.5", "Opus 5.0", "Sonnet 5.0"], min: "Claude Code ≥ 2.4", files: "CLAUDE.md, AGENTS.md" },
